...
describe('TasksService', () => {
  ...
  describe('getTaskById', () => {
    it('calls tasksRepository.findOne and successfully retrieve and returns the task', async () => {
    ...
    it('throws and error because task is not found', async () => {
  ...
  describe('deleteTask', () => {
    it('call tasksRepository.deleteTask to delete task', async () => {
    ...
    it('throws and error because task could not be found', async () => {
